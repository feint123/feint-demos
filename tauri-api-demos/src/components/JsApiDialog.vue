...
<template>
  ...
  >
    <el-descriptions-item v-for="dialog in dialogs" :label="dialog.title">
      <el-button type="info" plain @click="infoDialog(dialog.fn)">
        Info
      </el-button>
      <el-button type="warning" plain @click="warningDialog(dialog.fn)"
        >Warning</el-button
      >
      <el-button type="danger" plain @click="errorDialog(dialog.fn)"
        >Error</el-button
      >
    ...
    <el-descriptions-item label="Save" :span="2">
      <el-button type="primary" plain @click="saveFileDialog"
        >保存文件</el-button
      >
